...
- Significant evidence suggests detracking, like in the case of state wide in California, can harm high-achieving students (especially low-income ones reliant on school for rigor) by lowering expectations and limiting opportunities
- Detracking frequently becomes a political distraction from evidence-based improvement strategies, IB and Open Access to IB curriculum has way different implemications than detracking in parents' minds. 
